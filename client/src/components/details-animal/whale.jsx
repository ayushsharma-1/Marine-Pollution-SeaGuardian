...
// Import images (you would need to properly import these in your project)
import whaleHeaderImg from '/png-jpg/Screenshot 2024-04-22 155459.png';
import whalingImg3 from '/png-jpg/whaling 3.png';
import whalingImg1 from '/png-jpg/whaling.png';
import whalingImg4 from '/png-jpg/whaling 4.png';
import whalingImg2 from '/png-jpg/whaling 2.png';
  ...
  return (
    <div>
      <div id="details-header">
        ...
        <h1>Whaling:-</h1>
        <img src={whaleHeaderImg} alt="whale" />
      </div>

      <div className="details-info-block">
        <img src={whalingImg3} alt="Left Image" />
        <p>
          <h2>
            Whales, dolphins, and porpoises are categorized taxonomically in the order Cetacea. As mammals they are warnm blooded.
            There are over 80 extant species of cetaceans, categorized into two suborders: the toothed whales (odontocetes) and baleen whales (mysticetes).
          </h2>
        </p>
      </div>
      ...
      <div id="details-footer">
        <div className="details-footer-item">
          <img src={whalingImg1} alt="Footer Image 1" />
          <p>
            <h3>
              ...
              Cetaceans are also killed in a misguided effort to reduce competition for fish and several small cetaceans (small whale, dolphin, and porpoise species) are hunted for use as bait to catch fish.
            </h3>
          </p>
        </div>
        <div className="details-footer-item">
          <img src={whalingImg4} alt="Footer Image 2" />
          <p>
            <h3>
        ...
        <div className="details-footer-item">
          <img src={whalingImg2} alt="Footer Image 3" />
          <p>
            <h3>
      ...
      <div id="details-text-section">
        <h2><b>How does whaling affect the delicate balance of marine ecosystems?</b></h2>
        <hr />
        <p>
          Whales play a crucial role in marine ecosystems as apex predators and nutrient recyclers. Their removal disrupts food chains and can lead to imbalances in populations of other marine species.
        </p>
        
        <h2><b>What are the long-term consequences of reducing whale populations through whaling?</b></h2>
        <hr />
        <p>
          Long-term consequences include decreased biodiversity, altered marine habitats, and potential cascading effects on fisheries and global ocean health.
          By supporting international agreements such as the International Whaling Commission (IWC) and advocating for stronger enforcement mechanisms, governments can work together to combat illegal whaling activities.
        </p>
        
        <h2><b>How does the loss of whales impact the health of our oceans?</b></h2>
        <hr />
        <p>
          Whales contribute to nutrient cycling, carbon sequestration, and the regulation of plankton populations. Their absence can disrupt these processes, affecting the overall health and functioning of marine ecosystems.
        </p>
